...
# 
# Un randonneur est équipé d’un capteur enregistrant toutes les minutes l’altitude (en nombre -pas forcément entier- de mètres) à laquelle il se trouve. Compléter le code du fichier
# `denivele.py` pour calculer le dénivelé total, la plus longue montée et son dénivelé.
...
# Test:
print(montee([2.4, 1.1, 0.5, 1.2, 1.7, 0.4, 7.2])==(2, 8.0, 1.2))
