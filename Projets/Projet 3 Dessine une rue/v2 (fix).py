...
def toit_circulaire(largeur_bat:int):
    """Dessine un toit circulaire en partant de la droite vers la gauche.
...
def toit_triangulaire(largeur_bat:int):
    """Dessine un toit triangulaire dont la hauteur est aléatoire en partant de la droite vers la gauche.
...
def toit_plat(largeur_bat:int):
    """Dessine un toit plat  en partant de la droite vers la gauche.
...
def setup():
    ...
    Returns:
        ...
        float: Découpe de la rue en fonction du nombre d'immeuble
